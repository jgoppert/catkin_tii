...
class MavrosOffboardPosctlTest(object):
    ...
    def __init__(self):
        ...
        self.qualisys_sub = rospy.Subscriber('/qualisys/hb1/pose',
                                              PoseStamped,
    ...
    def reach_position(self, x, y, z, wait, timeout):
        ...
        yaw_degrees = 90 # North (0 lateral, 90 tail, 270 head)
    ...
    def test_posctl(self, positions):
        ...
        # ENU
        #positions = [(0, 0, 0.5), (0, 0, 0.5), (0, 0, 3.5), (0, 0, 3.5), (0, 0, .05)]# ROVER
        #positions = [(0, 0, 0.75), (0, 6, 0.75), (0, 6, -0.05)]#, (0, 0, -0.05)] #Cruise
        #positions = [(0, 6, 0.75), (0, 0, 0.75), (0, 0, -0.05)]#, (0, 0, -0.05)] #Cruise - RTH
        #positions = [(0, 0, 0.75), (0, 0, 0.75), (0, 0, 0.75), (0, 0, 0.75), (0, 0, -0.05)] # HOVER
        

        wait = 10
        timeout = 10 #20 cruise
        #timeout2 = 6
...
if __name__ == '__main__':
    ...
    valx  = 2.0*(8.0*np.random.random(1)-4.0)
    #valx = float(input("Enter Target X (in m):"))
    ...
    positions_RTH = [(currx, curry, 0.5), (valx, valy, valz), (0, 0, valz), (0, 0, -0.05)]
    
    
    # Return to Home - No Attack
